...
public class TaskRestControllerTest {
    ...
    void getUserTasks_shouldResponseWithListOfUserTasksAndOkStatusCode() throws Exception {
        ...
        when(taskService.getUserTasks(mockUser)).thenReturn(tasks);
    ...
    void getUserTask_shouldResponseWithUserTaskAndOkStatusCode() throws Exception {
        ...
        when(taskService.getUserTaskById(mockUser, 1L)).thenReturn(expected);
    ...
    void createTask_shouldResponseWithCreatedTaskAndOCreatedStatusCode() throws Exception {
        ...
        when(taskService.saveTask(mockUser, taskForm)).thenReturn(expected);
    ...
    void updateTask_shouldResponseWithCreatedTaskAndOCreatedStatusCode() throws Exception {
        ...
        when(taskService.userHasTask(mockUser, 1L)).thenReturn(true);
        when(taskService.updateTask(taskForm, 1L)).thenReturn(expected);
    ...
    void deleteTask_shouldResponseWithCreatedTaskAndOCreatedStatusCode() throws Exception {
        ...
        when(taskService.userHasTask(mockUser, 1L)).thenReturn(true);
        when(taskService.deleteTaskById(1L)).thenReturn(expected);
