...
public interface AuthService {
    ...
    AuthResponseForm register(SignupForm signupForm, BindingResult validationResult, HttpServletResponse response);
    AuthResponseForm login(LoginForm loginForm, BindingResult validationResult, HttpServletResponse response);
